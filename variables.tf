...
variable "kms_alias" {
  description = "Name of KMS alias to be attached."
  type = string
...
variable "windows_vss_backup" { # Need to create IAM roles for all EC2, documentation here: https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/application-consistent-snapshots-getting-started.html#run-command-vss-role
...
variable "principalOrgId" {
  description = "ID from AWS Organizations."
  type = string
}